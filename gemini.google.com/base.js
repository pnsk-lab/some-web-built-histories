...
;(function (_) {
 ...
 SPDX-License-Identifier: MIT
    */
    ...
    kba = function (a) {
      return Hb(a) ? _.lb(_.pba(a)) : _.lb(_.iba(a))
    }
    _.Aba = function (a) {
    ...
    Wba = function (a, b, c, d) {
      ...
      if (t) {
        for (let S in t) {
          ...
          h = +S
          let W
          if (x && !Number.isNaN(h) && (W = h + B) < g) f[W] = K
          else {
            let ea
            ;((ea = b) != null ? ea : b = {})[S] = K
          }
    ...
    Pba = class {}
    var Uba
    _.jf = Fga ? structuredClone : (a) => Wba(a, 0, Qb)
    var cca, dca
    _.Zga = _.lb(0)
    _.lf = {}
